...
from utils.general import (LOGGER, NUM_THREADS, segments2boxes, xyn2xy, xywhn2xyxy, xyxy2xywhn)
...
class LoadImages:
    # Image dataloader, i.e. `python detect.py --source image.jpg`
...
class LoadImagesAndLabels(Dataset):
    ...
    def __init__(self,
        ...
        self.path = path
        self.album = False
        self.albumentations = Albumentations() if augment and self.album else None
        ...
        cache_path = p.with_suffix('.cache')
        try:
