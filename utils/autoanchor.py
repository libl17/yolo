...
def check_anchors(dataset, model, thr=4.0, imgsz=640, fusion = False):
    # Check anchor fit to data, recompute if necessary
    detect_rank = -3 if fusion else -1
    m = model.module.model[detect_rank] if hasattr(model, 'module') else model.model[detect_rank]  # Detect()
