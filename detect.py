...
from utils.general import LOGGER, colorstr, increment_path, non_max_suppression, print_args, scale_coords, xyxy2xywh
...
def parse_opt():
    ...
    parser.add_argument('--data', type=str, default='data/pavement.yaml', help='(optional) dataset.yaml path')
...
def main(
    ...
    # Run inference
    model.warmup(imgsz=(1, channel, *imgsz))  # warmup
    ...
    LOGGER.info(f'Speed: %.1fms pre-process, %.1fms inference, %.1fms NMS per image at shape {(1, channel, *imgsz)}' % t)
